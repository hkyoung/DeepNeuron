...
files = ['/global/cscratch1/sd/asranjan/mainen4v29_pred/params/efel_data.h5', '/global/cscratch1/sd/asranjan/efel_pred/efel_data_7v31.h5', '/global/cscratch1/sd/asranjan/efel_pred/efel_data_10v32.h5']
vy_files = os.listdir(path)
for model in ['izhi', 'stick_4p', '7p', '10p']:
    for f in vy_files:
        if model in f:
            files += [path + f]
for f in files:
